...
// Filename   : sim.v
// Device     : SIM
// LiteX sha1 : 842df1738
// Date       : 2025-09-25 07:47:50
//------------------------------------------------------------------------------
...
always @(*) begin
    ...
    master[2] <= (shared_adr[29:14] == 15'd16384);
...
assign ram_bus_cyc = (shared_cyc & master[0]);
assign interface0_ram_bus_cyc = (shared_cyc & master[1]);
assign interface1_ram_bus_cyc = (shared_cyc & master[2]);
...
always @(*) begin
    shared_dat_r <= 32'd0;
    shared_dat_r <= (((({32{slaves[0]}} & ram_bus_dat_r) | ({32{slaves[1]}} & interface0_ram_bus_dat_r)) | ({32{slaves[2]}} & interface1_ram_bus_dat_r)) | ({32{slaves[3]}} & interface0_dat_r));
    if (done) begin
...
//------------------------------------------------------------------------------
// Memory rom: 6084-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-09-25 07:47:50.
//------------------------------------------------------------------------------
